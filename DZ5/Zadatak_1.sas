...
title "Veličina uzorka - 50";
%let N = 50; *velicina uzorka;
...
*koeficijent aimetrije kod normalne i t-distribucije je nepristran -> 
mean se nalazi na horizontalnoj crti
*kod većeg uzorka vidimo da je možda i koeficijent eksponencijalne distribucije nepristran;