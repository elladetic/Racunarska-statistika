...
proc sgplot data=WORK.ALL_FINAL;
	title height=10pt "Alpha = 0.05, n = 10";
...
proc sgplot data=WORK.ALL_FINAL;
	title height=10pt "Alpha = 0.05, n = 15";
	vline mu_0 / response=fraction_crit group=distribution;
	yaxis grid;
run;
...
proc sgplot data=WORK.ALL_FINAL;
	title height=10pt "Alpha = 0.05, n = 20";
	vline mu_0 / response=fraction_crit group=distribution;
	yaxis grid;
run;
...
proc sgplot data=WORK.ALL_FINAL;
	title height=10pt "Alpha = 0.05, n = 50";
	vline mu_0 / response=fraction_crit group=distribution;
	yaxis grid;
run;
...
proc sgplot data=WORK.ALL_FINAL;
	title height=10pt "Alpha = 0.05, n = 100";
	vline mu_0 / response=fraction_crit group=distribution;
	yaxis grid;
run;
